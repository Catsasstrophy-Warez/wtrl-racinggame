...
Civic Si has spanned many generations (EF9/EF8, EG6, EM1, FG2, FB6, FC1, and the current 11th-gen sedan); the figures below are for the current-production reference configuration only. Treat earlier generations (e.g. B16A2-powered EM1, 1999-2000) as a separate envelope requiring their own OEM/period-test sourcing before use as hard data.
- Engine: 1.5L turbocharged I4 (L15CA)
- Power: 200 hp @ 6000 rpm
- Torque: 192 lb-ft @ 1800-5000 rpm
- Transmission: 6MT, 4.350 final drive; helical LSD
- Drive layout: FWD
- Wheelbase: 107.7 in
- Curb weight: 2952 lb
- Evidence: SRC-019
...
## Primary sources
- **SRC-019 · Honda · grade A** — 2026 Civic Si specifications
  - https://automobiles.honda.com/civic-si-sedan/specs-features-trim-comparison
  - Research use: 200 hp, 192 lb-ft, 6MT ratios, helical LSD, suspension, 2952 lb
